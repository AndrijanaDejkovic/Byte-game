...
def minMax(state:GameState, depth:int = 0, alpha:tuple = None, beta:tuple = None):
    ...
    if copyState.currentTurn == "X":
        nextState = maxState(copyState, depth, alpha, beta)[0]
    else:
        nextState = minState(copyState, depth, alpha, beta)[0]  
